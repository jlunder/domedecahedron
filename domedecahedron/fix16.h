...
static const fix16_t fix16_sqrt_two       = 92682;      /*!< fix16_t value of sqrt(2) */
static const fix16_t fix16_sqrt_two_two   = 46341;      /*!< fix16_t value of sqrt(2)/2 */
static const fix16_t fix16_sqrt_three_two = 56756;      /*!< fix16_t value of sqrt(3)/2 (sin(pi/3)) */
